...
!$OMP END PARALLEL
    ...
    DO ispin=1,nspins
       DO ik=1,nk
          CALL GEMM(inp%rhok(:,:,ik,ispin),inp%fockk(:,:,ik,ispin),energy_test,'N','C',(1.d0,0.d0),(0.d0,0.d0))
...
!$OMP DO SCHEDULE(STATIC)
      DO ik=1,nk
         CALL GEMM(rhok(:,:,ik),sk(:,:,ik),dummy,'N','N',(1.d0,0.d0),(0.d0,0.d0))
         CALL GEMM(sk(:,:,ik),dummy,rhok(:,:,ik),'N','N',(1.d0,0.d0),(0.d0,0.d0))
      ENDDO
!$OMP END DO NOWAIT
!$OMP END PARALLEL
...
!$OMP DO SCHEDULE(STATIC)
      DO ik=1,nk
         ...
         dummy = idenk(:,:,ik)
         CALL GEMM(N,dummy,idenk(:,:,ik),'C','N',(1.d0,0.d0),(0.d0,0.d0))
      ENDDO
!$OMP END DO NOWAIT
!$OMP END PARALLEL
...
!$OMP DO SCHEDULE(STATIC)
      ...
      DO ik=1,nk
         ...
         dummy = idenk(:,:,ik)
         CALL GEMM(Os,dummy,idenk(:,:,ik),'N','N',(1.d0,0.d0),(0.d0,0.d0))
...
!$OMP DO SCHEDULE(STATIC)
      ...
      DO ik=1,nk
         ...
         dummy = idenk(:,:,ik)
         CALL GEMM(Ow,dummy,idenk(:,:,ik),'N','N',(1.d0,0.d0),(0.d0,0.d0))
...
!$OMP END PARALLEL
    ...
    FUNCTION schmidt_orthog_matrix(S,n) RESULT(Os)
      ...
      CALL GEMM(Sinv,S(1:n,n+1:nbasis),proj,'N','N',(1.d0,0.d0),(0.d0,0.d0))
    ...
    SUBROUTINE sort_pre_nao(N,W, S)
      ...
      IF (PRESENT(S)) THEN
         ...
         CALL GEMM(matsqrt(S),N,overlap,'N','N',1.d0,0.d0)
      ELSE
         overlap=N
      ENDIF
